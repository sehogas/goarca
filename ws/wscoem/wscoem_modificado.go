...
type Caratula struct {
	...
	FechaArribo string `xml:"FechaArribo,omitempty" json:"FechaArribo,omitempty"`

	FechaZarpada string `xml:"FechaZarpada,omitempty" json:"FechaZarpada,omitempty"`
...
type DeclaracionCont struct {
	...
	FechaEmbarque string `xml:"FechaEmbarque,omitempty" json:"FechaEmbarque,omitempty"`
}
