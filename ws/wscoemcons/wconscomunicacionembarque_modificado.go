...
type ConsultaEstadoCOEM struct {
	*AbstractEntidadOfString
	...
	FechaEstado *string `xml:"FechaEstado,omitempty" json:"FechaEstado,omitempty"`
...
type ConsultaNoAbordo struct {
	*AbstractEntidadOfString
	...
	FechaNoAbordo *string `xml:"FechaNoAbordo,omitempty" json:"FechaNoAbordo,omitempty"`
...
type DummyTestConnectionOutput struct {
	*AbstractEntidadOfInt32
	...
	Fecha string `xml:"Fecha,omitempty" json:"Fecha,omitempty"`
}
